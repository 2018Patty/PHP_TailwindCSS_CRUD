...
<body class="text-gray-600 font-body" onload="product_readone()">
    <!-- Container -->
    <div class="container mx-auto mt-10 p-3">
        ...
        <form onsubmit="" method="post" action="api/update_product.php" enctype="multipart/form-data">
            <div class="mt-5 border rounded-lg shadow w-1/2 space-y-12 mx-auto p-3">
                <div class="pb-5">
                    <h2 class="text-2xl text-center font-semibold text-gray-900">Update Product</h2>


                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="col-span-full">
                            <label for="productid" class="block text-sm/6 font-medium text-gray-900">Product
                                ID</label>
                            <div class="mt-2">
                                <div
    ...
    var product_readone = function() {
        ...
        fetch(
            ...
            .then((result) => {
                ...
                document.getElementById("product_id").value = jsobObj.id;
                document.getElementById("product_name").value = jsobObj.name;
                document.getElementById("product_desc").value = jsobObj.desc;
                document.getElementById("product_price").value = jsobObj.price;
                document.getElementById("product_instock").value = jsobObj.stock;
                document.getElementById("product_size").value = jsobObj.size;
