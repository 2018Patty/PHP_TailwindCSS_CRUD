...
--
-- Host: localhost
-- Generation Time: Feb 19, 2025 at 02:38 AM
...
INSERT INTO `ms_shoes` (`shoes_id`, `brand_id`, `shoes_name`, `description`, `size`, `price`, `stock`, `best_seller_flag`, `publish`, `create_date`, `image`) VALUES
(1, 1, 'adidas Originals Samoa - Mens Comin', 'Up in the \'80s, the adidas Originals Samoa blends a mix of upper materials with the iconic colorful stripes for a look that never falls off.', '42', 7000, 16, 0, 0, '2013-11-15 00:00:00', 'addidas-adidas_originals_samoa_-_mens_comin-090214083733.jpeg'),
(2, 1, 'adidas Originals Samba - Mens Famous ', 'For over five decades, the adidas Originals Samba celebrates it\'s vintage construction this season.', '43', 7300, 34, 0, 0, '2013-11-16 00:00:00', 'addidas-adidas_originals_samba_-_mens_famous_-090214112434.jpeg'),
(3, 4, 'Nike SB P. Rod 7 - Mens', 'A combination of perfection-minded performance and Nike innovation takes the Nike Paul Rodriguez 7 to the next level.', '44', 8700, 79, 0, 0, '2013-11-17 00:00:00', 'nike-nike_sb_p._rod_7_-_mens-090214083100.jpeg'),
(4, 1, 'adidas Originals Samoa - Mens', 'Comin\' up in the \'80s, the adidas Originals Samoa blends a mix of upper materials with the iconic colorful stripes for a look that never falls off. An injected rubber outsole features the unique Trefoil tread that screams adidas style. The EVA midsole provides the cushioning you\'ll love while rockin\' your swag. Be a student of the sneaker game in the adidas Originals Samoa.', '45', 6800, 47, 0, 0, '2013-11-18 00:00:00', 'addidas-adidas_originals_samoa_-_mens-090214112109.jpeg'),
(5, 6, 'Vans- Authentic Core Classics', 'Indulge in track-running nostalgia with the Vans Core Classic. This contemporary update of the Bowerman-designed classic features a basic, good-looking profile that never gets old', '45', 6500, 12, 0, 0, '2013-11-19 00:00:00', 'vans-vans-_authentic_core_classics-090214082925.jpeg'),
(6, 5, 'El Ace 3 L Sneaker Shoes', '- Sneakers\r\n- Upper material: leather\r\n- Outsole material: rubber\r\n- Warna hitam\r\n- Tali depan\r\n- Round toe', '45', 9800, 25, 0, 0, '2013-11-20 00:00:00', 'puma-el_ace_3_l_sneaker_shoes-090214082745.jpeg'),
(7, 2, 'Mens The ONE- Blue Suede', 'Airwalk\'s most popular heritage style of all time, the ONE was recently named Complex Magazine\'s 25 Sneakers You Should Own Before You Die. Don\'t miss out. ', '43', 8900, 45, 0, 0, '2013-11-21 00:00:00', 'airwalk-mens_the_one-_blue_suede-090214082547.jpeg'),
(11, 7, 'Flying Dutch Sneakers', '- Canvas upper\r\n- Rubber outsole\r\n- Warna hitam\r\n- Detail tali warna kontras\r\n- Aksen stitching', '', 4190, 78, 0, 0, '2013-12-19 11:43:26', 'kael-flying_dutch_sneakers-090214111537.jpeg');
...
CREATE TABLE `tr_usr_grp_access` (
...
--
-- Indexes for table `ms_shoes`
--
ALTER TABLE `ms_shoes`
  ADD PRIMARY KEY (`shoes_id`);

--
-- Indexes for table `ms_shoes_image`
--
ALTER TABLE `ms_shoes_image`
  ADD PRIMARY KEY (`image_id`);

--
-- Indexes for table `ms_user_admin`
--
ALTER TABLE `ms_user_admin`
...
--
-- Indexes for table `tr_testimonial`
--
ALTER TABLE `tr_testimonial`
...
--
-- AUTO_INCREMENT for table `ms_shoes`
--
ALTER TABLE `ms_shoes`
  MODIFY `shoes_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `ms_shoes_image`
--
ALTER TABLE `ms_shoes_image`
  MODIFY `image_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;

--
-- AUTO_INCREMENT for table `ms_user_admin`
--
ALTER TABLE `ms_user_admin`
...
--
-- AUTO_INCREMENT for table `tr_testimonial`
--
ALTER TABLE `tr_testimonial`
